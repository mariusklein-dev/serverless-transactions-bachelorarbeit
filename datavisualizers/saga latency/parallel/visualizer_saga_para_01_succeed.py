...
json_file_path = 'sagaparallel_succeed_2.json'
...
plt.title('Sequentiell paralleles Saga Latenztestszenario ohne Umgebungsparameter mit Ausreißereliminierung, erfolgreich')
