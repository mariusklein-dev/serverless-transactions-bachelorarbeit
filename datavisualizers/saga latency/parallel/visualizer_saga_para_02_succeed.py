...
json_file_path = '25_50_saga_success.json'
...
#kaltstartwerte
first_batch_average = average_latencies[0]
...
plt.title('Sequentiell paralleles Saga Latenztestszenario mit Umgebungsparametern, erfolgreich')
