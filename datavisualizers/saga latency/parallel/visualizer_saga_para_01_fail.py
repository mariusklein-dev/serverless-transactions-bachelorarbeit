...
json_file_path = 'sagaparallel_fail.json'
...
plt.title('Sequentiell paralleles Saga Latenztestszenario ohne Umgebungsparameter mit Ausreißereliminierung, fehlgeschlagen')
