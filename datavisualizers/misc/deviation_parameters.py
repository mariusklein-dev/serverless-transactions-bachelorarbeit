...
json_file_paths = [
    'deviation_data/p0.json',
    'deviation_data/p1.json',
    'deviation_data/p2.json',
    'deviation_data/p3.json',
    'deviation_data/p4.json',
    'deviation_data/p5.json',
    'deviation_data/p6.json',
    'deviation_data/p7.json',
    'deviation_data/p8.json',
    'deviation_data/p9.json',
]
...
plt.title('Abweichung der Datenerhebungen von Batch-Daten mit Parametern, erhoben mit 2PC erfolgreich')
