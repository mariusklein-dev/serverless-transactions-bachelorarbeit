...
json_file_paths = [
    'deviation_data/s_0.json',
    'deviation_data/s_1.json',
    'deviation_data/s_2.json',
    'deviation_data/s_3.json',
    'deviation_data/s_4.json',
    'deviation_data/s_5.json',
    'deviation_data/s_6.json',
    'deviation_data/s_7.json',
    'deviation_data/s_8.json',
    'deviation_data/s_9.json',
]
...
plt.title('Abweichung der Datenerhebungen von Batch-Daten ohne Parameter, erhoben mit Saga erfolgreich')
