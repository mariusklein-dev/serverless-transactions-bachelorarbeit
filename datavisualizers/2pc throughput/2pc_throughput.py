...
y_min = min(min_count_0, min_count_0) - 25
y_max = max(max_count_0, max_count_0) + 25
...
ax0.set_xlabel('Index des Tests', fontsize=15)
ax0.set_ylabel('Anzahl der Transaktionen in 60 Sekunden', fontsize=15)
ax0.set_title('Durchsatz des 2PC-Musters')
ax0.set_xticks(x)
...
ax1.set_ylim(-640, y_max)
ax1.legend(title=f'Durchschnittliche Latenz: {overall_average_latency_1:.2f} ms')
ax1.set_xlabel('Index des Tests mit steigender Parallelität', fontsize=15)
ax1.set_ylabel('')
