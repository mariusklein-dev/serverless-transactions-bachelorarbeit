...
json_file_path = '2pc_parallel_noinstance_fail.json'
...
plt.title('Sequentiell paralleles 2PC Latenztestszenario ohne Umgebungsparameter mit Ausreißereliminierung, fehlgeschlagen')
